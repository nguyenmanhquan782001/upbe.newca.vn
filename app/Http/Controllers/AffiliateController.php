...
class AffiliateController extends Controller
{
    ...
    public function affiliate(Request $request)
    {
        try {
            ...
            // gán giá trị liên kết mặc định .
            curl_setopt($cURLConnection, CURLOPT_URL, $affiliate_users_link);
            /*
              // cấu hình cho cUrl,
               ts1 : Đối tượng cUrl
               ts2 : Tên cấu hình.
                   + CURLOPT_URL : đường dẫn tới CURL cần xử lí.
                   +
               ts3 : cấu hình thông dụng cho cUrl
            */
            curl_setopt($cURLConnection, CURLOPT_RETURNTRANSFER, true);
            /*
                 CURLOPT_RETURNTRANSFER:  trả về kết quả ở hàm curl_exec
                 */
